...
SENF_AUTO_UNIT_TEST(statistics)
{
    ...
    CHECK_STATS( statslog.str(),
            "level0 -1 2.3 2.5 0\n"
            "level0 -1 2.35 3.8 0\n"
            "level0 -1.1 1.05 3.8 0\n"
            "level0 -1.1 1.45 3.3 0\n"
            "level1 -1.1 1.9 3.8 1.31719\n"
            "averaged1 -1.1 1.9 3.8 1.31719\n"
            "level0 -0.3 2.15 3.3 0\n"
            "level0 0.5 0.8 1.1 0\n"
            "level0 0 0.25 0.5 0\n"
            "level0 -2 -0.9 0 0\n"
            "level1 -2 -0.05 1.1 1.08282\n"
            "averaged1 -2 0.925 3.8 1.20001\n"
            "level0 -2 0.25 2.4 0\n"
            "level0 0 1.75 2.4 0\n"
            "level0 -1 1.75 2.5 0\n"
            "level0 -1 2.35 3.8 0\n"
            "level1 -1 2.05 3.8 0.492442\n"
            "averaged1 -2 1.3 3.8 0.964152\n"
            "level0 -1.1 1.05 3.8 0\n"
            "level0 -1.1 1.45 3.3 0\n"
            "level0 -0.3 2.15 3.3 0\n"
            "level0 0.5 0.8 1.1 0\n"
            "level1 -1.1 1.125 3.3 1.29687\n"
            "averaged1 -2 1.04167 3.8 0.957378\n"
            "level0 0 0.25 0.5 0\n"
            "level0 -2 -0.9 0 0\n"
            "level0 -2 0.25 2.4 0\n"
            "level0 0 1.75 2.4 0\n"
            "level1 -2 0.425 2.4 1.52049\n"
            "averaged1 -2 1.2 3.8 1.10327\n"
            "level0 -1 1.75 2.5 0\n"
            "level0 -1 2.35 3.8 0\n"
            "level0 -1.1 1.05 3.8 0\n"
            "level0 -1.1 1.45 3.3 0\n"
            "level1 -1.1 1.9 3.8 1.31719\n"
            "averaged1 -2 1.15 3.8 1.37818\n"
            ...
            "level0 -2 -0.9 0 0\n"
            "level1 -2 -0.05 1.1 1.08282\n"
            "averaged1 -2 0.758333 3.8 1.30683\n"
            "level0 -2 0.25 2.4 0\n"
            "level0 0 1.75 4 0\n" );
    ...
    CHECK_STATS( statslog.str(),
            ...
            "averaged1 -2 2.575 10 3.53185\n"
            "level1 10 10 10 0\n"
            "averaged1 -2 5.275 10 3.09279\n"
            "level1 10 10 10 0\n"
            "averaged1 0 8.625 10 2.73185\n"
            "level1 10 10 10 0\n"
            ...
            "averaged1 0 8.33333 10 2.88675\n" );
