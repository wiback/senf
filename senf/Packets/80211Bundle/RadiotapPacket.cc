...
static MCSInfo mcsInfo[] =
    {
        {0,     1,      "BPSK_1/2",       {6500,          7200,  13500,  15000}},
        {1,     1,      "QPSK_1/2",      {13000,         14400,  27000,  30000}},
        {2,     1,      "QPSK_3/4",      {19500,         21700,  40500,  45000}},
        {3,     1,      "16-QAM_1/2",    {26000,         28900,  54000,  60000}},
        {4,     1,      "16-QAM_3/4",    {39000,         43300,  81000,  90000}},
        {5,     1,      "64-QAM_2/3",    {52000,         57800, 108000, 120000}},
        {6,     1,      "64-QAM_3/4",    {58500,         65000, 121500, 135000}},
        {7,     1,      "64-QAM_5/6",    {65000,         72200, 135000, 150000}},

        {8,     2,      "BPSK_1/2",      {13000,         14400,  27000,  30000}},
        {9,     2,      "QPSK_1/2",      {26000,         28900,  54000,  60000}},
        {10,    2,      "QPSK_3/4",      {39000,         43300,  81000,  90000}},
        {11,    2,      "16-QAM_1/2",    {52000,         57800, 108000, 120000}},
        {12,    2,      "16-QAM_3/4",    {78000,         86700, 162000, 180000}},
        {13,    2,      "64-QAM_2/3",   {104000,        115600, 216000, 240000}},
        {14,    2,      "64-QAM_3/4",   {117000,        130000, 243000, 270000}},
        {15,    2,      "64-QAM_5/6",   {130000,        144400, 270000, 300000}},

        {16,    3,      "BPSK_1/2",      {19500,         21700,  40500,  45000}},
        {17,    3,      "QPSK_1/2",      {39000,         43300,  81000,  90000}},
        {18,    3,      "QPSK_3/4",      {58500,         65000, 121500, 135000}},
        {19,    3,      "16-QAM_1/2",   {780000,         86700, 162000, 180000}},
        {20,    3,      "16-QAM_3/4",   {117000,        130700, 243000, 270000}},
        {21,    3,      "64-QAM_2/3",   {156000,        173300, 324000, 360000}},
        {22,    3,      "64-QAM_3/4",   {175500,        195000, 364500, 405000}},
        {23,    3,      "64-QAM_5/6",   {195000,        216700, 405000, 450000}},

        {24,    4,      "BPSK_1/2",      {26000,         28800,  54000,  60000}},
        {25,    4,      "QPSK_1/2",      {52000,         57600, 108000, 120000}},
        {26,    4,      "QPSK_3/4",      {78000,         86800, 162000, 180000}},
        {27,    4,      "16-QAM_1/2",   {104000,        115600, 216000, 240000}},
        {28,    4,      "16-QAM_3/4",   {156000,        173200, 324000, 360000}},
        {29,    4,      "64-QAM_2/3",   {208000,        231200, 432000, 480000}},
        {30,    4,      "64-QAM_3/4",   {234000,        260000, 486000, 540000}},
        {31,    4,      "64-QAM_5/6",   {260000,        288800, 540000, 600000}},
    };


static unsigned getRate( unsigned char mcs, unsigned bandwidth, bool shortGI)
{
    if( mcs > 31)
        return 0;
