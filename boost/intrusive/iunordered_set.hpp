...
//! The class template iunordered_set is an intrusive container, that mimics most of 
//! the interface of std::tr1::unordered_set as described in the C++ TR1.
//!
//! iunordered_set is a pseudo-intrusive container: each object to be stored in the
//! container must contain a proper hook, but the container also needs
//! additional auxiliary memory to work: iunordered_set needs a pointer to an array
//! of type `bucket_type` to be passed in the constructor. This bucket array must
//! have at least the same lifetime as the container. This makes the use of
//! iunordered_set more complicated than purely intrusive containers.
...
//!
//! iunordered_set only provides forward iterators but it provides 4 iterator types:
...
//!
//! It's not recommended to use non ConstantTimeSize iunordered_sets because several
//! key functions, like "empty()", become non-constant time functions. Non
//! ConstantTimeSize iunordered_sets are mainly provided to support auto-unlink hooks.
//!
//! iunordered_set, unlike std::unordered_set, does not make automatic rehashings nor
...
class iunordered_set
{
   ...
   //! This class is
   //! non-assignable
   iunordered_set &operator =(const iunordered_set&);
   ...
   //!
   //! <b>Effects</b>: Constructs an empty iunordered_set, storing a reference
   ...
   //!   *this is destroyed. 
   iunordered_set( bucket_ptr buckets
   ...
   //! 
   //! <b>Effects</b>: Constructs an empty iunordered_set and inserts elements from 
   //!   [b, e).
   //!   
   ...
   //! <b>Effects</b>: Detaches all elements from this. The objects in the iunordered_set 
   //!   are not deleted (i.e. no destructors are called).
   //! 
   //! <b>Complexity</b>: Linear to the number of elements in the iunordered_set, if 
   ...
   //! <b>Effects</b>: Returns an iterator pointing to the beginning of the iunordered_set.
   //! 
   //! <b>Complexity</b>: Amortized constant time.
   //!   Worst case (empty iunordered_set): O(this->bucket_count())
   //! 
   //! <b>Throws</b>: Nothing.
   iterator begin()
   { return table_.begin();  }
   ...
   //! <b>Effects</b>: Returns an iterator pointing to the end of the iunordered_set.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ...
   //! <b>Effects</b>: Returns a const_iterator pointing to the end of the iunordered_set.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ...
   //! <b>Effects</b>: Returns the hasher object used by the iunordered_set.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   ...
   //! <b>Effects</b>: Returns the key_equal object used by the iunordered_set.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   ...
   //! <b>Effects</b>: Returns the number of elements stored in the iunordered_set.
   //! 
   ...
   //! 
   //! <b>Effects</b>: Swaps the contents of two iunordered_sets.
   ...
   void clone_from(const iunordered_set &src, Cloner cloner, Destroyer destroyer)
   {  table_.clone_from(src.table_, cloner, destroyer);  }

   //! <b>Requires</b>: value must be an lvalue
   //! 
   //! <b>Effects</b>: Tries to inserts value into the iunordered_set.
   //!
   ...
   //! 
   //! <b>Effects</b>: Checks if a value can be inserted in the iunordered_set, using
   ...
   //!   objects are inserted or erased from the iunordered_set.
   ...
   //!   No objects should have been inserted or erased from the iunordered_set between
   //!   the "insert_check" that filled "commit_data" and the call to "insert_commit".
   //! 
   //! <b>Effects</b>: Inserts the value in the iunordered_set using the information obtained
   ...
   //! <b>Requires</b>: value must be an lvalue and shall be in a iunordered_set of
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid iterator i belonging to the iunordered_set
   ...
   {  return table_.current(value);  }

   //! <b>Requires</b>: value must be an lvalue and shall be in a iunordered_set of
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid const_iterator i belonging to the
   //!   iunordered_set that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: If the internal hash function throws.
   ...
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid local_iterator i belonging to the iunordered_set
   //!   that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   ...
   {  return table_type::current_local(value);  }

   //! <b>Requires</b>: value must be an lvalue and shall be in a iunordered_set of
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid const_local_iterator i belonging to
   //!   the iunordered_set that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ...
   size_type bucket(const KeyType& k,  KeyHasher hasher)
...
//! The class template iunordered_multiset is an intrusive container, that mimics most of 
//! the interface of std::tr1::unordered_multiset as described in the C++ TR1.
//!
//! iunordered_multiset is a pseudo-intrusive container: each object to be stored in the
//! container must contain a proper hook, but the container also needs
//! additional auxiliary memory to work: iunordered_multiset needs a pointer to an array
//! of type `bucket_type` to be passed in the constructor. This bucket array must
//! have at least the same lifetime as the container. This makes the use of
//! iunordered_multiset more complicated than purely intrusive containers.
//! `bucket_type` is default-constructible, copyable and assignable
//!
//! The template parameter ValueTraits is called "value traits". It stores
//! information and operations about the type to be stored in the container.
...
//! This will allow constant-time O(1) size() member, instead of default O(N) size.
//!
//! iunordered_multiset only provides forward iterators but it provides 4 iterator types:
//! iterator and const_iterator to navigate through the whole container and
//! local_iterator and const_local_iterator to navigate through the values
//! stored in a single bucket. Local iterators are faster and smaller.
//!
//! It's not recommended to use non ConstantTimeSize iunordered_multisets because several
//! key functions, like "empty()", become non-constant time functions. Non
//! ConstantTimeSize iunordered_multisets are mainly provided to support auto-unlink hooks.
//!
//! iunordered_multiset, unlike std::unordered_set, does not make automatic rehashings nor
//! offers functions related to a load factor. Rehashing can be explicitly requested
//! and the user must provide a new bucket array that will be used from that moment.
//!
//! Since no automatic rehashing is done, iterators are never invalidated when
...
class iunordered_multiset
{
   ...
   //! This class is
   //! non-assignable
   iunordered_multiset &operator =(const iunordered_multiset&);
   ...
   //! <b>Requires</b>: buckets must not be being used by any other resource.
   //!
   //! <b>Effects</b>: Constructs an empty iunordered_multiset, storing a reference
   //!   to the bucket array and copies of the hasher and equal functors.
   //!   
   //! <b>Complexity</b>: Constant. 
   //! 
   ...
   //! <b>Notes</b>: buckets array must be destroyed only after
   //!   *this is destroyed. 
   iunordered_multiset  ( bucket_ptr buckets
                  , size_type buckets_len
                  , const Hash & hasher = Hash()
                  , const Equal &equal = Equal()) 
      :  table_(buckets, buckets_len, hasher, equal)
   ...
   //!   and Dereferencing iterator must yield an lvalue of type value_type.
   //! 
   //! <b>Effects</b>: Constructs an empty iunordered_multiset and inserts elements from 
   //!   [b, e).
   //!   
   //! <b>Complexity</b>: If N is std::distance(b, e): Average case is O(N)
   //!   (with a good hash function and with buckets_len >= N),worst case O(N2).
   ...
   //! <b>Effects</b>: Detaches all elements from this. The objects in the iunordered_multiset 
   //!   are not deleted (i.e. no destructors are called).
   //! 
   //! <b>Complexity</b>: Linear to the number of elements in the iunordered_multiset, if 
   //!   it's a safe-mode or auto-unlink value. Otherwise constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ~iunordered_multiset() 
   ...
   //! <b>Effects</b>: Returns an iterator pointing to the beginning of the iunordered_multiset.
   //! 
   //! <b>Complexity</b>: Amortized constant time.
   //!   Worst case (empty iunordered_multiset): O(this->bucket_count())
   //! 
   //! <b>Throws</b>: Nothing.
   iterator begin()
   { return table_.begin();  }
   ...
   //! <b>Effects</b>: Returns an iterator pointing to the end of the iunordered_multiset.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ...
   //! <b>Effects</b>: Returns a const_iterator pointing to the end of the iunordered_multiset.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
   ...
   //! <b>Effects</b>: Returns the key_equal object used by the iunordered_multiset.
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: If key_equal copy-constructor throws.
   ...
   //! <b>Effects</b>: Returns the number of elements stored in the iunordered_multiset.
   //! 
   //! <b>Complexity</b>: Linear to elements contained in *this if
   //!   ConstantTimeSize is false. Constant-time otherwise.
   //! 
   ...
   //!   call should not throw.
   //! 
   //! <b>Effects</b>: Swaps the contents of two iunordered_multisets.
   //!   Swaps also the contained bucket array and equality and hasher functors.
   //!
   //! 
   //! <b>Complexity</b>: Constant.
   ...
   //! <b>Throws</b>: If the swap() call for the comparison or hash functors
   //!   found using ADL throw. Basic guarantee.
   void swap(iunordered_multiset& other)
   { table_.swap(other.table_); }
   ...
   template <class Cloner, class Destroyer>
   void clone_from(const iunordered_multiset &src, Cloner cloner, Destroyer destroyer)
   {  table_.clone_from(src.table_, cloner, destroyer);  }

   //! <b>Requires</b>: value must be an lvalue
   //! 
   //! <b>Effects</b>: Inserts value into the iunordered_multiset.
   //!
   ...
   //! <b>Requires</b>: value must be an lvalue and shall be in a iunordered_multiset of
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid iterator i belonging to the iunordered_multiset
   //!   that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   ...
   //! 
   //! <b>Effects</b>: Returns: a valid const_iterator i belonging to the
   //!   iunordered_multiset that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: If the hash function throws.
   ...
   //!   appropriate type. Otherwise the behavior is undefined.
   //! 
   //! <b>Effects</b>: Returns: a valid local_iterator i belonging to the iunordered_multiset
   //!   that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   ...
   //! 
   //! <b>Effects</b>: Returns: a valid const_local_iterator i belonging to
   //!   the iunordered_multiset that points to the value
   //! 
   //! <b>Complexity</b>: Constant.
   //! 
   //! <b>Throws</b>: Nothing.
